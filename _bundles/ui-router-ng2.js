...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('ui-router-core'), require('@angular/common'), require('rxjs/ReplaySubject'), require('rxjs/BehaviorSubject'), require('rxjs/observable/of'), require('rxjs/observable/fromPromise'), require('rxjs/observable/combineLatest'), require('rxjs/operator/switchMap'), require('rxjs/operator/mergeMap'), require('rxjs/operator/map'), require('rxjs/operator/concat'), require('@angular/router'), require('ui-router-rx')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'ui-router-core', '@angular/common', 'rxjs/ReplaySubject', 'rxjs/BehaviorSubject', 'rxjs/observable/of', 'rxjs/observable/fromPromise', 'rxjs/observable/combineLatest', 'rxjs/operator/switchMap', 'rxjs/operator/mergeMap', 'rxjs/operator/map', 'rxjs/operator/concat', '@angular/router', 'ui-router-rx'], factory) :
	(factory((global['ui-router-ng2'] = global['ui-router-ng2'] || {}),global.ng.core,global['ui-router-core'],global.ng.common,global.Rx,global.Rx,global.Rx.Observable,global.Rx.Observable,global.rxjs_observable_combineLatest,global.rxjs_operator_switchMap,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.rxjs_operator_concat,global._angular_router,global['ui-router-rx']));
}(this, (function (exports,_angular_core,uiRouterCore,_angular_common,rxjs_ReplaySubject,rxjs_BehaviorSubject,rxjs_observable_of,rxjs_observable_fromPromise,rxjs_observable_combineLatest,rxjs_operator_switchMap,rxjs_operator_mergeMap,rxjs_operator_map,rxjs_operator_concat,_angular_router,uiRouterRx) { 'use strict';
 ...
 */
/** @module decorators */ function ResolveData(token) {
...
var Ng2LocationConfig = (function (_super) {
    ...
    function Ng2LocationConfig(router, _locationStrategy) {
        var _this = _super.call(this, router, uiRouterCore.is(_angular_common.PathLocationStrategy)(_locationStrategy)) || this;
        _this._locationStrategy = _locationStrategy;
        return _this;
    }
...
var _UIROUTER_INSTANCE_PROVIDERS = [
    { provide: uiRouterCore.UIRouter, useFactory: uiRouterFactory, deps: [_angular_common.LocationStrategy, UIROUTER_ROOT_MODULE, UIROUTER_MODULE_TOKEN, _angular_core.Injector] },
