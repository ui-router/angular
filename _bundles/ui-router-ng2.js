 ...
 * @version v1.0.0-beta.6-hybrid-2.0.0-4
 * @link https://ui-router.github.io/ng2
 * @license MIT License, http://www.opensource.org/licenses/MIT
 */
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@uirouter/core'), require('@angular/common'), require('rxjs/ReplaySubject'), require('rxjs/BehaviorSubject'), require('rxjs/observable/of'), require('rxjs/observable/fromPromise'), require('rxjs/observable/combineLatest'), require('rxjs/operator/switchMap'), require('rxjs/operator/mergeMap'), require('rxjs/operator/map'), require('rxjs/operator/concat'), require('@angular/router'), require('rxjs/add/operator/mergeMap'), require('rxjs/add/operator/map')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@uirouter/core', '@angular/common', 'rxjs/ReplaySubject', 'rxjs/BehaviorSubject', 'rxjs/observable/of', 'rxjs/observable/fromPromise', 'rxjs/observable/combineLatest', 'rxjs/operator/switchMap', 'rxjs/operator/mergeMap', 'rxjs/operator/map', 'rxjs/operator/concat', '@angular/router', 'rxjs/add/operator/mergeMap', 'rxjs/add/operator/map'], factory) :
	(factory((global['@uirouter/angular'] = global['@uirouter/angular'] || {}),global.ng.core,global['@uirouter/core'],global.ng.common,global.Rx,global.Rx,global.Rx.Observable,global.Rx.Observable,global.rxjs_observable_combineLatest,global.rxjs_operator_switchMap,global.Rx.Observable.prototype,global.Rx.Observable.prototype,global.rxjs_operator_concat,global._angular_router));
}(this, (function (exports,_angular_core,_uirouter_core,_angular_common,rxjs_ReplaySubject,rxjs_BehaviorSubject,rxjs_observable_of,rxjs_observable_fromPromise,rxjs_observable_combineLatest,rxjs_operator_switchMap,rxjs_operator_mergeMap,rxjs_operator_map,rxjs_operator_concat,_angular_router) { 'use strict';
...
var UIRouterRx = (function () {
    function UIRouterRx(router) {
        ...
        var transStarted = function (transition) {
            return start$.next(transition);
        };
        this.deregisterFns.push(router.transitionService.onStart({}, transStarted));
...
var Ng2LocationConfig = (function (_super) {
    __extends$1(Ng2LocationConfig, _super);
