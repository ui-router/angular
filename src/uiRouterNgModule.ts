...
import {ANALYZE_FOR_ENTRY_COMPONENTS, APP_INITIALIZER, InjectionToken, Injector, ModuleWithProviders, NgModule, Provider} from "@angular/core";
import {CommonModule, HashLocationStrategy, LocationStrategy, PathLocationStrategy} from "@angular/common";
import {_UIROUTER_DIRECTIVES} from "./directives/directives";
import {UIView} from "./directives/uiView";
import {TargetState, TargetStateDef, TransitionService, UIRouter, UrlRuleHandlerFn} from "@uirouter/core";
import {_UIROUTER_INSTANCE_PROVIDERS, _UIROUTER_SERVICE_PROVIDERS} from "./providers";

import {ROUTES} from "@angular/router";

/** @hidden */
export const UIROUTER_ROOT_MODULE = new InjectionToken("UIRouter Root Module");
/** @hidden */
export const UIROUTER_MODULE_TOKEN = new InjectionToken("UIRouter Module");
/** @hidden */
export const UIROUTER_STATES = new InjectionToken("UIRouter States");
